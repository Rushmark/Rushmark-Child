...
class rushmark_Block_Area {
	...
	/**
	 * Class Instance.
	 * @return rushmark_Block_Area
	 */
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof rushmark_Block_Area ) ) {
			self::$instance = new rushmark_Block_Area();
 ...
 * @return object
 */
function rushmark_block_area() {
	return rushmark_Block_Area::instance();
}
rushmark_block_area();
