 ...
 *
 */
function rushmark_remove_genesis_templates( $page_templates ) {
	unset( $page_templates['page_archive.php'] );
	unset( $page_templates['page_blog.php'] );
	return $page_templates;
}
add_filter( 'theme_page_templates', 'rushmark_remove_genesis_templates' );

/**
 * Custom search form
 *
 */
function rushmark_search_form() {
	ob_start();
	get_template_part( 'searchform' );
	return ob_get_clean();
}
add_filter( 'genesis_search_form', 'rushmark_search_form' );

/**
 * Disable customizer theme settings
 *
 */
function rushmark_disable_customizer_theme_settings( $config ) {
...
add_filter( 'genesis_customizer_theme_settings_config', 'rushmark_disable_customizer_theme_settings' );
